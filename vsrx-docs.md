...
| ------------- | ------------- |
[Juniper vSRX Overview](https://www.juniper.net/documentation/product/us/en/vsrx/){: external} | Learn about Juniper vSRX and its extensive features. |
...
[Intrusion Detection and Prevention on IBM Cloud](https://cloud.ibm.com/media/docs/downloads/vSRX/IBM%20Cloud_vSRX_IDP.pdf){: external} | IDP is Intrusion Detection and Prevention. Detection is the process of monitoring the events occurring in your network and analyzing them for signs of possible threats to your security policies. Prevention refers to the process stopping the detected incidents. |
...
[vSRX J-Web access on IBM Cloud Classic](https://cloud.ibm.com/media/docs/downloads/vSRX/IBM%20Cloud_vSRX_J-Web_Access.pdf){: external} | This guide explains how to enable and troubleshoot vSRX J-Web access on IBM Cloud Classic by removing HTTPS interface bindings, permitting localhost traffic, and configuring a custom management URL when J-Web shares an interface with IKE gateways. |
...
[Juniper Secure Connect: Configuration Guide for Classic Infrastructure on IBM Cloud](https://cloud.ibm.com/media/docs/downloads/vSRX/IBM%20Cloud_vSRX_Secure-Connect-Guide.pdf){: external} | Juniper Secure Connect is a client-based SSL-VPN application that allows you to securely connect and access protected resources on your network. |
