...
# 取得 {{site.data.keyword.vsrx_full}} 的協助及支援
...
* 如果您有 {{site.data.keyword.vsrx_full}} Standard 的相關技術問題，請將問題張貼在 [Stack Overflow](https://stackoverflow.com/search?q=vsrx+ibm-cloud) 上，並使用 "vsrx" 和 "ibm-cloud" 來標記問題。
