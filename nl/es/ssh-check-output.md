...
Su {{site.data.keyword.vsrx_full}} Estándar está ahora configurado para direccionar y filtrar el tráfico a la nueva VLAN y subred, permitiendo sólo los pings y las conexiones SSH de entrada.
